...
const UnlinkExternalSourceMutation_1 = require("../graphQL/UnlinkExternalSourceMutation");
compass_requests_1.CompassRequests.prototype.unlinkExternalSource = async function unlinkExternalSource(input) {
    let gqlErrors, mutationErrors, errorsResp = [];
    let data;
    try {
        const resp = await this.api.requestGraph(UnlinkExternalSourceMutation_1.UnlinkExternalSource, { input });
...
//# sourceMappingURL=unlinkExternalSource.js.map