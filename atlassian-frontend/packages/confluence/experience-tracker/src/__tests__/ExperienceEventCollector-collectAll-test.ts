...
it('should succeed the main experience as soon as all sub-experiences succeed', () => {
  // Arrange
  startExperience(
    Experience.Main,
    collectAll([Experience.SubExperience1, Experience.SubExperience2]),
  );

  // Act
  startExperience(Experience.SubExperience1);
  startExperience(Experience.SubExperience2);
  succeedExperience(Experience.SubExperience2);
