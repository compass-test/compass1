...
export const ActiveTourContainer = styled.div`
  display: flex;
...
export const InactiveTourContainer = styled.button`
  display: flex;
...
// Note the override in TourDataContainer, for compatibility
// with OpsGenie base styles. `h4${TourHeading}`
export const TourHeading = styled.h4`
  ${h400};

  font-size: 14px;
`;

export const TourDataContainer = styled.div`
  flex-grow: 1;
...
export const TourParagraph = styled.p`
  color: ${N200};
...
export const InactiveTourList = styled.div<{ isExpanded: boolean }>`
  display: flex;
  flex-direction: column;
  overflow: hidden;
  /* Margin is reduced to account for the 5px in the footer (see below) */
  margin-bottom: ${(props) => (props.isExpanded ? gridSize() - 5 : 0)}px;
`;
...
export const Footer = styled.div`
  ...
  /* Hacky way to add 5px to the header only when the inactive tour list is collapsed */
  margin-top: 5px;
`;
