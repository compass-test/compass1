...
describe('filterFilePath', () => {
  it('gets correct packages with specified dependency', async () => {
    ...
    expect(packages).toEqual([
      'packages/monorepo-tooling/codemod-cli/src/__tests__/__fixtures__/foo',
    ]);
  });
  ...
  it('gets correct packages with specified dependency', async () => {
    ...
    expect(packages).toEqual([
      'packages/monorepo-tooling/codemod-cli/src/__tests__/__fixtures__/bar',
      'packages/monorepo-tooling/codemod-cli/src/__tests__/__fixtures__/baz',
    ]);
  });
