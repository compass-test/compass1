...
- [`c85009b470f`](https://bitbucket.org/atlassian/atlassian-frontend/commits/c85009b470f) - Add webpackInclude into i18n dynamic imports

## 19.0.5

### Patch Changes

- [`e1f2ac1bc5a`](https://bitbucket.org/atlassian/atlassian-frontend/commits/e1f2ac1bc5a) - Do case insensitive check against APS cloudId

## 19.0.4

### Patch Changes

- [`e25423d22b2`](https://bitbucket.org/atlassian/atlassian-frontend/commits/e25423d22b2) - Allow status code to be undefined in provider retry

## 19.0.3

### Patch Changes

- [`839ee5a91e4`](https://bitbucket.org/atlassian/atlassian-frontend/commits/839ee5a91e4) - Improvements to analytics related to the joinable sites section. Events for the section will only be sent in products where it is used.

## 19.0.2

### Patch Changes

- [`bcd4b96855e`](https://bitbucket.org/atlassian/atlassian-frontend/commits/bcd4b96855e) - Fix bug where provider retry config wasn't being passed through

## 19.0.1

### Patch Changes

- [`cfc5b2e85ae`](https://bitbucket.org/atlassian/atlassian-frontend/commits/cfc5b2e85ae) - Lazy load switcher locale data

## 19.0.0

### Major Changes

- [`385159e3e33`](https://bitbucket.org/atlassian/atlassian-frontend/commits/385159e3e33) - Removed unused feature flags.

## 18.2.11

### Patch Changes

- [`a25e83febb6`](https://bitbucket.org/atlassian/atlassian-frontend/commits/a25e83febb6) - Add retries to data providers

## 18.2.10

### Patch Changes

- [`4a45b65ad59`](https://bitbucket.org/atlassian/atlassian-frontend/commits/4a45b65ad59) - Updated Switcher prefetch to handle Trello product Switcher

## 18.2.9

### Patch Changes

- [`26737b5d044`](https://bitbucket.org/atlassian/atlassian-frontend/commits/26737b5d044) - Prefetch remote-configuration before available-products

## 18.2.8

### Patch Changes

- [`3bc8fbb36b4`](https://bitbucket.org/atlassian/atlassian-frontend/commits/3bc8fbb36b4) - Resolved an issue where the remote configuration pre-fetch was not caching correctly due to a different key
...
- [`484db330704`](https://bitbucket.org/atlassian/atlassian-frontend/commits/484db330704) - Adds viewed analytics to confluence notificaiton banner
...
- [`6c49b1ea0d4`](https://bitbucket.org/atlassian/atlassian-frontend/commits/6c49b1ea0d4) - ACT-2184 use trello gateway origin for product-configuration

## 18.2.3

### Patch Changes

- [`c85096ea5a0`](https://bitbucket.org/atlassian/atlassian-frontend/commits/c85096ea5a0) - Use the product defined URL if it exists for any product

## 18.2.2

### Patch Changes

- [`0632a934b53`](https://bitbucket.org/atlassian/atlassian-frontend/commits/0632a934b53) - [ux] Added box shadow to icons

## 18.2.1

### Patch Changes

- [`50487a41e21`](https://bitbucket.org/atlassian/atlassian-frontend/commits/50487a41e21) - Removes ref from SwitchToSectionBannerNotification component
...
- [`908d2493023`](https://bitbucket.org/atlassian/atlassian-frontend/commits/908d2493023) - [ux] Adds new Confluence notification banner wrapping Confluence section of switcher component if consumer wants to notify the user about a change
...
- [`babda8d741e`](https://bitbucket.org/atlassian/atlassian-frontend/commits/babda8d741e) - [ux] Reverting the short Red Dot Switcher Growth experiment for Jira -> Confluence
