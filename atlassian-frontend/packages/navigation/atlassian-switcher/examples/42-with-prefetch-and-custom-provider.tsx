...
} from '@atlassian/switcher-test-utils';
...
} from '../src/create-custom-provider';
...
const customProductConfigurationProvider = createProductConfigurationProvider({
        ...
        <Drawer onClose={this.onClose} isOpen={this.state.isDrawerOpen}>
          <AtlassianSwitcher
            ...
            productConfigurationDataProvider={
              customProductConfigurationProvider
            }
          />
        </Drawer>
