...
class TeamCentralSwitcherExample extends React.Component {
  state = {
    isDrawerOpen: false,
  };
          ...
          sites: [
            {
              ...
              availableProducts: [
                ...
                {
                  productType: 'TEAM_CENTRAL',
                  url: 'https://team.atlassian.com',
                },
              ],
...
export default withIntlProvider(
  withAnalyticsLogger(TeamCentralSwitcherExample),
);
