...
import type { InvitedUser, Team } from '../src/types';
...
class ExampleWithMockedData extends React.PureComponent<{}, State> {
  ...
  componentDidUpdate() {
    const { statusRequest, hasOrgId } = this.state;
    ...
    if (statusRequest === 'success') {
      mockCreateTeam(
        ...
        TEST_PRODUCT,
        undefined,
        hasOrgId ? TEST_ORG_ID : undefined,
      );
      mockInviteTeamMembers(
        TEST_CLOUD_ID,
        TEST_PRODUCT,
      ...
      <div>
        ...
        <SectionWrapper>
          ...
          <section>
            ...
            <Checkbox
              ...
              value="hasOrgId"
              name="hasOrgId"
              onChange={this.handleChangeCheckBox('hasOrgId')}
            />
          </section>
        </SectionWrapper>
        ...
        {isOpenDialog && (
          <TeamCreateDialog
            ...
            orgId={hasOrgId ? TEST_ORG_ID : undefined}
          />
        )}
      </div>
    );
