...
export default function ListProjectFormsWithCustomNestedIntlExample() {
  const locale = Locale.ja_JP;
  const customLocale = Locale.fr_FR;
                  ...
                  <ProjectFormApiProvider projectFormApi={mockProjectFormApi}>
                    <ProjectApiProvider projectApi={mockProjectApi}>
                      <ProjectIdProvider projectId={0}>
                        <FlagsProvider>
                          <ListProjectForms customLocale={customLocale} />
                          <ModalTransition>
