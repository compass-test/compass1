...
import { ExternalProps as KeyboardWrapperProps } from '../../../src/extensible/focus-and-keyboard-wrapper/focus-and-keyboard-wrapper';

export default (arg: KeyboardWrapperProps) => null;
