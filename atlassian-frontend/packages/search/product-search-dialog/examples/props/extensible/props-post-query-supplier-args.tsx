...
import { PostQuerySupplierArgs } from '../../../src/extensible/product-router/product/result-provider/result-provider-types';

export default (arg: PostQuerySupplierArgs) => null;
