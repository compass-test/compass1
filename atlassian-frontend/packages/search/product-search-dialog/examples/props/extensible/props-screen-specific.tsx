...
import { ScreenSpecificProps } from '../../../src/extensible/product-router/product/result-provider/result-renderer/result-renderer-types';

export default (arg: ScreenSpecificProps) => null;
