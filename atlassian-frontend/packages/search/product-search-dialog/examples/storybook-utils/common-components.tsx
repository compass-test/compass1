...
export const emptyContent = (dataTestId?: string) => {
  return () => (
    <div
      data-test-id={dataTestId || 'empty-content'}
      style={{
        width: 175,
        height: 250,
      }}
...
const HelpContent = emptyContent('help');
...
const ProfileContent = emptyContent('profile');
...
export const PrimaryDropdown = (props: PrimaryDropdownProps) => {
  ...
  return (
    <Popup
      ...
      trigger={(triggerProps) => (
        <PrimaryDropdownButton
          testId={`nav-bar-${text.toLowerCase()}`}
          onClick={onClick}
          onKeyDown={onKeyDown}
          {...triggerProps}
        >
