...
describe('<ConfluenceSearchProvider />', () => {
  ...
  it('provides access to clients for the child components', () => {
    ...
    const props = wrapper.find(DummyComponent).props();

    expect(props['recentClient']).toBeTruthy();
    expect(props['searchClient']).toBeTruthy();
  });
