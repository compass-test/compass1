...
export const PreQueryNoItem = () => (
  <ConfluencePreQuery {...defaultProps} items={emptyProps.items} />
);

export const PreQueryNoSpace = () => (
  <ConfluencePreQuery {...defaultProps} spaces={emptyProps.spaces} />
);

export const PreQueryNoPeople = () => (
  <ConfluencePreQuery {...defaultProps} people={emptyProps.people} />
);
