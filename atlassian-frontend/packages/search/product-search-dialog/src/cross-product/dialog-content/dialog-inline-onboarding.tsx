...
const DialogInlineOnboarding = React.memo(
  ({ primaryProduct, activeProduct }: OnboardingProps) => {
    ...
    const { cloudId: jiraCloudId } = useJiraSearchClientContext();
    ...
    const client = useMemo(
      () =>
        new CoordinationClient(jiraCloudId || confluenceCloudId, stargateUrl),
      [jiraCloudId, confluenceCloudId, stargateUrl],
    );
