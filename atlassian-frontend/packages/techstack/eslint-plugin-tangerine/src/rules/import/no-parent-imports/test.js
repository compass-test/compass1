...
ruleTester.run('no-parent-imports', rule, {
  valid: [
    ...
    },
    {
      ...
      code:
        "import { RelativeHeaderButtonAbsoluteDir } from './header/button';",
      filename: '/Users/dev/src/ui/dialog/index.js',
      options: [
        {
          dirs: ['/Users/dev/src/ui'],
  ...
  invalid: [
    ...
    },
    {
      ...
      code:
        "import { RelativeHeaderButtonAbsoluteDir } from '../something/button';",
      filename: '/Users/dev/src/ui/dialog/index.js',
      options: [
        {
          dirs: ['/Users/dev/src/ui'],
...
describe('basePath should fallback to package root if not provided', () => {
  beforeAll(() => {
    getPkgRoot.mockImplementation(() => '/Users/dev/src');
  });
