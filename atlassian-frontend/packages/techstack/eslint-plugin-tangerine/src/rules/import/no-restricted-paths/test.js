...
jest.mock('../../../utils/get-pkg-root', () => jest.fn(() => mockCwd()));
...
ruleTester.run('no-restricted-paths', rule, {
  valid: [
    ...
    },
    {
      ...
      code:
        "import { AbsoluteImportRelativeTarget } from 'controllers/my-controller'",
      filename: '/Users/test/src/ui/foo.js',
      options: [
        {
    ...
    },
    {
      ...
      code:
        "import { AbsoluteImportAndTarget } from 'controllers/my-controller'",
      filename: '/Users/test/src/ui/foo.js',
      options: [
        {
          basePath: '/Users/test/src',
    ...
    },
    {
      ...
      code:
        "import { RelativeWithBasePath } from '../controllers/my-controller'",
  ...
  invalid: [
    ...
    },
    {
      ...
      code:
        "import { AbsoluteTargetRelativeImport } from '../../../uncommon/util/'",
    ...
    },
    {
      ...
      code:
        "import { RelativeWithBasePath } from 'my-pkg/src/controllers/my-controller'",
    ...
    },
    {
      ...
      code:
        "import { AbsoluteWithBasePath } from '../controllers/my-controller'",
      filename: '/Users/test/src/my-pkg/src/services/foo.js',
      options: [
        {
          basePath: '/Users/test/src/my-pkg/src',
...
describe('basePath should fallback to package root if not provided', () => {
  beforeAll(() => {
    getPkgRoot.mockImplementation(() => '/Users/test/src/my-pkg');
  });
