  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        present and future Contributions submitted to Atlassian. In return,
        Atlassian will use commercially reasonable efforts to use Contributions
        to improve Atlassian's products and open source projects and to include
        your name in a list of contributors. Except for the license granted
        herein to Atlassian and recipients of software distributed by Atlassian,
      ...
      <p>
        ...
        Atlassian. For legal entities, the entity making a Contribution and all
      ...
      <p>
        ...
        submitted by You to Atlassian for inclusion in, or documentation of, any
        of the products owned or managed by Atlassian (the "Work"). For the
        purposes of this definition, "submitted" means any form of electronic,
        verbal, or written communication sent to Atlassian or its
        representatives, including but not limited to communication on
        electronic mailing lists, source code control systems, and issue
        tracking systems that are managed by, or on behalf of, Atlassian for the
      ...
      <p>
        ...
        this Agreement, You hereby grant to Atlassian and to recipients of
        software distributed by Atlassian a perpetual, worldwide, non-exclusive,
      ...
      <p>
        ...
        Agreement, You hereby grant to Atlassian and to recipients of software
        distributed by Atlassian a perpetual, worldwide, non-exclusive,
      ...
      <p>
        ...
        Atlassian, or that your employer has executed a separate Corporate
      ...
      <p>
        ...
        You may submit it to Atlassian separately from any Contribution,
      ...
      <p>
        8. You agree to notify Atlassian of any facts or circumstances of which
...
export default IndividualCLAContent;
